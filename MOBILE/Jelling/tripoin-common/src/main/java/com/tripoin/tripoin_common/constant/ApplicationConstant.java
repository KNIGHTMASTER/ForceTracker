...
public interface ApplicationConstant {
    ...
    interface Rest {
        String INIT_HOST = "93.188.165.47";
        int INIT_PORT = 8280;
    ...
    interface Database {
        ...
        interface TableForce {
            String TABLE_NAME = "tsm_force";
            String NAME = "tsm_name";
            String PHONE_NUMBER = "tsm_phone_number";
            String IMEI = "tsm_imei";
            String IMSI = "tsm_imsi";
            String LATITUDE = "tsm_latitude";
            String LONGITUDE = "tsm_longitude";
        }
